...
$jndata = file_get_contents("currentserver.txt");
ob_start();
?>


print("Hello person reading the logs")
loadfile('http://66.78.126.165/2014host/game/host.php<?php echo $jndata; ?>')();
...
local result = pcall(function() game:GetService("ScriptContext"):AddStarterScript(3) end)
if not result then
  pcall(function() game:GetService("ScriptContext"):AddCoreScript(3,game:GetService("ScriptContext"),"StarterScript") end)
end
<?php
$data = ob_get_clean();
$signature;
