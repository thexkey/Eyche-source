...
REM BFCPEICON=H:\RobloxRevivals\Eyche\SOURCE_CODE_DO_NOT_DELETE\icon_HGz_icon.ico
...
IF EXIST %cd%\launcher\servers.txt for /f "delims=" %%x in (%cd%\launcher\servers.txt) do (set servers=%%x)
...
%MYFILES%\cmdmenusel 0870 "2009 Server" "2010 Server" "2011 Server" "2012 Server" "2013 Server" "2014 Server" "2015 Server" "Go back to menu"
IF %ERRORLEVEL%==1 set year=2009
IF %ERRORLEVEL%==2 set year=2010
IF %ERRORLEVEL%==3 set year=2011
IF %ERRORLEVEL%==4 set year=2012
IF %ERRORLEVEL%==5 set year=2013
IF %ERRORLEVEL%==6 set year=2014
IF %ERRORLEVEL%==7 set year=2015
...
IF %year%==2012 start %cd%\%year%\EychePlayer -a "http://66.78.126.165/game/getcoreui.ashx?year=2012" -t "http://66.78.126.165/game/getcoreui.ashx?year=2012" -j "http://66.78.126.165/game/join2.php?username=%user%&ip=66.78.126.165&port=4096&id=%id%&app=%app%&membership=%membership%"
IF %year%==2013 start %cd%\%year%\EychePlayer -a "http://66.78.126.165/game/getcoreui.ashx?year=2013" -t "http://66.78.126.165/game/getcoreui.ashx?year=2013" -j "http://66.78.126.165/game/join2.php?username=%user%&ip=66.78.126.165&port=5004&id=%id%&app=%app%&membership=%membership%"
IF %year%==2014 start %cd%\%year%\Eyche -a "http://66.78.126.165/game/getcoreui.ashx?year=2014" -t "http://66.78.126.165/game/getcoreui.ashx?year=2014" -j "http://www.eycheis.ga/game/join.ashx?username=%user%&ip=66.78.126.165&port=1002&id=%id%&app=%app%&membership=%membership%"
IF %year%==2015 start %cd%\%year%\Eyche.exe -ide -script loadfile(\"http://66.78.126.165/game/join.ashx?username=%user%&ip=66.78.126.165&port=2001&id=%id%&app=%app%&membership=%membership%\")() -levelNo5 -avatar -fullsc
...
%MYFILES%\cmdmenusel 0870 "2009" "2010" "2011" "2012" "2013" "2014" "2015" "Go back to menu"
IF %ERRORLEVEL%==1 set year=2009
IF %ERRORLEVEL%==2 set year=2010
IF %ERRORLEVEL%==3 set year=2011
IF %ERRORLEVEL%==4 set year=2012
...
IF %year%==2012 start %cd%\%year%\EychePlayer -a "http://66.78.126.165/game/getcoreui.ashx?year=2012" -t "http://66.78.126.165/game/getcoreui.ashx?year=2012" -j "http://66.78.126.165/game/join2.php?username=%user%&ip=%ip%&port=%port%&id=%id%&app=%app%&membership=%membership%"
IF %year%==2013 start %cd%\%year%\EychePlayer -a "http://66.78.126.165/game/getcoreui.ashx?year=2013" -t "http://66.78.126.165/game/getcoreui.ashx?year=2013" -j "http://66.78.126.165/game/join2.php?username=%user%&ip=%ip%&port=%port%&id=%id%&app=%app%&membership=%membership%"
IF %year%==2014 start %cd%\%year%\Eyche.exe -a "http://66.78.126.165/game/getcoreui.ashx?year=2014" -t "http://66.78.126.165/game/getcoreui.ashx?year=2014" -j "http://www.eycheis.ga/game/join.ashx?username=%user%&ip=%ip%&port=%port%&id=%id%&app=%app%&membership=%membership%"
IF %year%==2015 start %cd%\%year%\Eyche.exe -ide -script loadfile(\"http://66.78.126.165/game/join.ashx?username=%user%&ip=%ip%&port=%port%&id=%id%&app=%app%&membership=%membership%\")() -levelNo5 -avatar -fullsc
ping localhost -n 3 >nul
goto main
:host
cls
...
IF EXIST %cd%\%year%\content\server\place.rbxl del %cd%\%year%\content\server\place.rbxl
IF %year%==2015 start %cd%\%year%\eyche.exe -ide -script "loadfile(\"http://66.78.126.165/game/gameserver2015.ashx\")(0, %port%, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, 0)" -fileLocation %map% -levelNo5
IF %year%==2014 copy %map% %cd%\%year%\content\server\place.rbxl >nul && start %cd%\%year%\Eyche -a "http://www.eycheis.ga/game/getcoreui.ashx?year=2014" -t "http://66.78.126.165/game/getcoreui.ashx?year=2014" -j "http://www.eycheis.ga/game/gameserver.ashx?port=%port%"
...
IF %year%==2012 start %cd%\%year%\eycheserver.exe %map% -script "loadfile('http://66.78.126.165/game/gameserver.txt')(0, %port%)" -%rendertype%
...
%MYFILES%\cmdmenusel 0870 "No3d (Faster server, just sound and server stats only, only works on 2013 and older)" "3d (Normal 3d world server)"
...
IF %ERRORLEVEL%==1 set membership=0
IF %ERRORLEVEL%==2 set membership=1
IF %ERRORLEVEL%==3 set membership=2
IF %ERRORLEVEL%==4 set membership=3
echo Settings updated^^!
ping localhost -n 3 >nul
goto settings
:savsvrs
...
echo Please choose a client to connect with:
%MYFILES%\cmdmenusel 0870 "2009" "2010" "2011" "2012" "2013" "2014" "2015"
IF %ERRORLEVEL%==1 set year=2009
IF %ERRORLEVEL%==2 set year=2010
IF %ERRORLEVEL%==3 set year=2011
IF %ERRORLEVEL%==4 set year=2012
